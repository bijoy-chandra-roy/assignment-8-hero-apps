      ...
      <div className="flex flex-col md:flex-row md:justify-between gap-8 md:gap-4 p-8 md:p-10">
        ...
        <nav className="flex-1">
          ...
          <div className="flex gap-4">
            <a href="https://x.com/Bijoy00001" className="hover:opacity-80 transition" target="_blank">
              <svg
            ...
            <a href="https://www.youtube.com/@bijoychandraroy" className="hover:opacity-80 transition" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <a href="https://www.facebook.com/bijoychandraroy001/" className="hover:opacity-80 transition" target="_blank">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
